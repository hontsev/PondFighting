...
BlocklyGames.soy.levelLinks = function(opt_data, opt_ignored, opt_ijData) {
  var output = ' &nbsp; ';
  var iLimit171 = opt_data.maxLevel + 1;
  for (var i171 = 1; i171 < iLimit171; i171++) {
    output += ' ' + ((i171 == opt_data.level) ? '<span class="level_number level_done" id="level' + soy.$$escapeHtml(i171) + '">' + soy.$$escapeHtml(i171) + '</span>' : (i171 == opt_data.maxLevel) ? '<a class="level_number" id="level' + soy.$$escapeHtml(i171) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i171) + soy.$$escapeHtml(opt_data.suffix) + '">' + soy.$$escapeHtml(i171) + '</a>' : '<a class="level_dot" id="level' + soy.$$escapeHtml(i171) + '" href="?lang=' + soy.$$escapeHtml(opt_data.lang) + '&level=' + soy.$$escapeHtml(i171) + soy.$$escapeHtml(opt_data.suffix) + '"></a>');
  }
  return output;
};
if (goog.DEBUG) {
